...
export function VoyageWorkspacePage() {
  ...
  const [selectedPortCallId, setSelectedPortCallId] = useState<string | null>(null);
  const [activeTab, setActiveTab] = useState<"reports" | "instructions">("reports");
    ...
    <div style={{ padding: "2rem", width: "100%" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "2rem" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
          ...
          <BunkerRequestPanel voyageId={voyageId} />
          <AlertsPanel voyageId={voyageId} />
          <TasksPanel voyageId={voyageId} />
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
